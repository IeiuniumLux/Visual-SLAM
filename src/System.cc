...
cout << "Begginign bReuse" << endl << endl;
    //Create the Map
    if (!bReuse)
    {
       mpMap = new Map();
	   ...
	   // if (bReuse)
	  {
           cout << "Should go in load map" << endl << endl;
    ...
    mpFrameDrawer = new FrameDrawer(mpMap, false);
...
{
    {
        cout << endl << filename <<" : Trying to Load Map!" << endl;
